...
module.exports = async function handler(req, res){
  ...
  let url = req.query.cursor ? decodeURIComponent(req.query.cursor) : `${MEDILINK_BASE}/pacientes`;
  ...
  return res.status(200).json({
    ...
    siguienteCursor: siguienteCursor ? encodeURIComponent(siguienteCursor) : null,
    nota: terminado
